...
import { AnchorNftStacking } from "../target/types/anchor_nft_stacking";
import {
...
describe("nft-staking", () => {
  ...
  const program = anchor.workspace
    .AnchorNftStacking as Program<AnchorNftStacking>;
  ...
  it("Unstake NFT", async () => {
    ...
    let account = await program.account.user.fetch(userAccount);
